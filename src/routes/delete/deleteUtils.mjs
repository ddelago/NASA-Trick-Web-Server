...
import { removeChannel, trickVariableMap, trickVariableTree, channelList } from '../../common/variables';
export { deleteRequest as default };

var channelsRemoved = [];

function deleteRequest(channel, trickClient) {
